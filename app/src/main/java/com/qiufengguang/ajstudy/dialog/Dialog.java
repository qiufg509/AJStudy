...
public class Dialog extends BaseDialog implements IDialog {
    ...
    public static class Builder {
        private final DialogController.Params params;
        private OnBuildListener buildListener;
        private OnDismissListener dismissListener;
        ...
        public Builder setScreenWidthP(float percentage) {
            params.dialogWidth = (int) (DisplayMetricsHelper.getScreenWidth(params.context) * percentage);
            return this;
        }
         ...
         * @return Builder
         */
        public Builder setScreenHeightP(@FloatRange(from = 0.0f, to = 1.0f) float percentage) {
            int screenHeight = DisplayMetricsHelper.getScreenHeight(params.context);
            int statusBarHeight = DisplayMetricsHelper.getStatusBarHeight(params.context);
            params.dialogHeight = (int) ((screenHeight - statusBarHeight) * percentage);
            return this;
        }
        ...
        /**
         * 设置dialog外点击是否可以让dialog消失，默认为false
         *
         * @param cancelableOutSide true 则在dialog窗口外点击可以使dialog消失
         * @return Builder
         */
        ...
        public void show() {
            ...
            removePreDialog();
            dialog.showAllowingLoss(params.fragmentManager, TAG);
        }
        ...
        private void removePreDialog() {
            ...
            Fragment prev = params.fragmentManager.findFragmentByTag(TAG);
            if (prev != null) {
                ft.remove(prev);
            }
            ft.commitAllowingStateLoss();
