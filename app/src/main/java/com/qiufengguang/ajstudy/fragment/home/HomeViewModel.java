...
public class HomeViewModel extends ViewModel {
    ...
    private void initData() {
        ...
        LayoutData<List<SeriesCardBean>> seriesCardData2 = new LayoutData<>(SeriesCardBean.LAYOUT_NAME, seriesCardBeans2, "SERIES 1");
        ...
        LayoutData<List<LargeGraphicCardBean>> lgcData2 = new LayoutData<>(LargeGraphicCardBean.LAYOUT_NAME, lgcBeans2, "时下热门");
